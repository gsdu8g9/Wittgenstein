...
class Instagram {
    ...
    */
    ...
    public function getRecentTags($tagName, $maxId = '', $minId = '') {
        ...
        $endpointUrl = sprintf($this->_endpointUrls['tags_recent'], $tagName, $maxId, $minId, $this->_config['client_id']); 
        $this->_initHttpClient($endpointUrl);
        return $this->_getHttpClientResponse();
    }
    ...
    public function searchTags($tagName) {
        ...
        $endpointUrl = sprintf($this->_endpointUrls['tags_search'], urlencode($tagName), $this->_config['client_id']);
        $this->_initHttpClient($endpointUrl);
        return $this->_getHttpClientResponse();
    }
